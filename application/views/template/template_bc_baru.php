...
<div class="wrapper">
	...
	<header class="main-header">
		...
		<nav class="navbar navbar-inverse" style="background: #00529c;">
			...
			<div class="container-fluid">
				...
				<?php $role = $this->mymodel->selectDataone('role',['id'=>$this->session->userdata('role_id')]); 

								$jsonmenu = json_decode($role['menu']); $this->db->order_by('urutan asc'); 
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown dropdown-large">
							...
							<ul class="dropdown-menu dropdown-menu-large row" style="background-color: white;">
								...
								foreach ($menu as $m) { 
									...
									if($m['large_dropdown']!='ya'){continue;}

									if ($m['type']=='menu') { 

										$this->db->where_in('id',$jsonmenu); 

										$this->db->order_by('urutan asc'); $parent =
											...
											<?php } ?>
													...
													<?php foreach ($parent as $p) { 
														...
														if ($p['type']=='menu') {
															...
															$role_slug  = $this->session->userdata('role_slug'); $user_id = $this->session->userdata('id'); ?>
						...
						foreach ($menu as $m) {
							...
							if($m['large_dropdown']!='tidak'){continue;}
							...
							if ($m['type']=='menu') {
							  ...
							  <li class="dropdown">
								  ...
								  <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="<?= $m['icon'] ?>"></i> <?= $m['name'] ?> <span
	...
	<header class="main-header">
		...
		<nav class="navbar navbar-static-top" style="background: #00529c;">
			...
			<div class="navbar-custom-menu" style="float: left; width: 100%">
			...
			?>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown dropdown-large">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><div class="fa fa-bars"></div> Main Menu <b class="caret"></b></a>

						<ul class="dropdown-menu dropdown-menu-large row" style="width: 75%;">
							...
							<?php foreach ($menu as $m) { 
								...
								if ($m['type']=='menu') { 
									...
									<?php if(count($parent)!=0){ $i++;?>
										...
										<li class="col-sm-3" style="padding: 0px;">
							...
							<?php if ($this->session->userdata('departement')==2) {?>
								<li class="col-sm-3" style="padding: 0px;">
									<ul>
										<li class="dropdown-header">
											DASHBOARD
										...
										<li>
											<a href="<?= base_url('home') ?>">Arsip</a>
										</li>
										<li>
											<a href="<?= base_url('home/sponsorship') ?>">Sponsorship</a>
										</li>
										<li>
											<a href="<?= base_url('home/vendor') ?>">Vendor / Konsultan</a>
										</li>
									</ul>
								</li>
								<li class="col-sm-3" style="padding: 0px;">
									<ul>
										...
										<li>
											<a href="<?= base_url('master/sponsorship') ?>">Sponsorship</a>
										</li>
										<li>
											<a href="<?= base_url('master/vendor') ?>">Vendor / Konsultan</a>
										</li>
									</ul>
								</li>
							<?php }?>
				...
				<ul class="nav navbar-nav" style="float: right;">
					...
					<li class="dropdown user user-menu">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<!-- <object data="" type="image/png" class="user-image" alt="User Image"> -->

								<img src="<?= base_url().$file['dir'] ?>" class="user-image" alt="User Image">
						...
						<ul class="dropdown-menu">
							...
							<li class="user-header" style="background: #00529c !important">
								...
								<!-- <object data="" type="image/png" style="width: 100px;height: 100px;"> -->
									...
									<img src="<?= base_url().$file['dir'] ?>" alt="example">
...
<script type="text/javascript">
	...
	tinymce.init({selector:'#disposisi'});
