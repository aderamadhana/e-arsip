  <form method="POST" action="<?= base_url('master/M_posisi/store') ?>" id="upload-create" enctype="multipart/form-data">
    <div class="show_error"></div>
      <div class="form-group">
          <label for="form-mp_nama">Nama Posisi</label>
          <input type="text" class="form-control" id="form-mp_nama" placeholder="Masukan Nama Posisi" name="dt[mp_nama]">
      </div>
