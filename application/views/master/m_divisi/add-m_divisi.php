  <form method="POST" action="<?= base_url('master/M_divisi/store') ?>" id="upload-create" enctype="multipart/form-data">
    <div class="show_error"></div>
    <div class="form-group">
      <label for="form-md_nama">Nama Divisi</label>
      <input type="text" class="form-control" id="form-md_nama" placeholder="Masukan Nama Divisi" name="dt[md_nama]">
    </div>
    <div class="form-group">
      <label for="form-md_singkatan">Nama Singkatan</label>
      <input type="text" class="form-control" id="form-md_singkatan" placeholder="Masukan Nama Singkatan" name="dt[md_singkatan]">
    </div>
