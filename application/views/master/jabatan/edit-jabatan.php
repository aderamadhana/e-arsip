  ...
  <div class="content-wrapper" style="background-color: #F5F7FF;">
    ...
    <form method="POST" action="<?= base_url('master/Jabatan/update') ?>" id="upload-create" enctype="multipart/form-data">
                ...
                <div class="show_error"></div>
                  <div class="form-group">
                    ...
                    <select name="dt[role_id]" class="form-control select2" style="width:100%">
                      ...
                      $text="";
                      if($role_record['id']==$jabatan['role_id']){
                      $text = "selected";
                      }
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="form-jabatan" placeholder="Masukan Jabatan" name="dt[jabatan]" value="<?= $jabatan['jabatan'] ?>">
                  </div>
