  <form method="POST" action="<?= base_url('master/Klasifikasi/store') ?>" id="upload-create" enctype="multipart/form-data">
    <div class="show_error"></div>
      <div class="form-group">
          <label for="form-klasifikasi">Klasifikasi</label>
          <input type="text" class="form-control" id="form-klasifikasi" placeholder="Masukan Klasifikasi" name="dt[klasifikasi]">
      </div>
