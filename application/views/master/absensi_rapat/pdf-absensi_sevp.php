...
<body>
    <center>
        ...
        <?php } ?>
        <h2>Absensi Kehadiran SEVP Rapat <?= $judulrapat[$absensi_rapat['ar_tipe_rapat']] ?></h2>
    </center>
    ...
    <table style="width: 100%;" border="1px">
        ...
        <tbody>
            ...
            $direksi = $this->mymodel->selectWhere('m_posisi_jabatan', ['mpj_mp_id' => '2', 'status' => 'ENABLE']);
            ...
            ?>
                <tr>
                    ...
                    <?php
                    // Get Tanda tangan
                    $absensi_direksi = $this->mymodel->selectDataone('absensi_rapat_enroll', ['are_ar_id' => $absensi_rapat['ar_id'], 'are_tipe' => 'SEVP', 'are_mpj_id' => $dir['mpj_id']]);
                    ?>
                    <?php if (($number % 2) != 0) { ?>
