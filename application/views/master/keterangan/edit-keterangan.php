  <!-- Content Wrapper. Contains page content -->
    <form method="POST" action="<?= base_url('master/Keterangan/update') ?>" id="upload-create" enctype="multipart/form-data">
      <input type="hidden" name="id" value="<?= $keterangan['id'] ?>">
      <div class="show_error"></div>

      <div class="form-group">
        <label for="form-keterangan">Keterangan</label>
        <input type="text" class="form-control" id="form-keterangan" placeholder="Masukan Keterangan" name="dt[keterangan]" value="<?= $keterangan['keterangan'] ?>">
      </div>
