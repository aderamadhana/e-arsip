  <!-- Content Wrapper. Contains page content -->
    <form method="POST" action="<?= base_url('master/Tipe/update') ?>" id="upload-create" enctype="multipart/form-data">
      ...
      <div class="form-group">
          ...
          <option value="consultant" <?=($tipe['kategori']=="consultant")?"selected":""?> >Consultant</option>
       <option value="vendor" <?=($tipe['kategori']=="vendor")?"selected":""?> >Vendor</option>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="form-tipe" placeholder="Masukan Tipe" name="dt[tipe]" value="<?= $tipe['tipe'] ?>">
      </div>
