  <form method="POST" action="<?= base_url('master/Master_breakdown/store') ?>" id="upload-create" enctype="multipart/form-data">
    <div class="show_error"></div>
      <div class="form-group">
          <label for="form-mb_keterangan">Keterangan</label>
          <input type="text" class="form-control" id="form-mb_keterangan" placeholder="Masukan Keterangan" name="dt[mb_keterangan]">
      </div>

      <div class="form-group">
          <label for="form-mb_biaya">Breakdown Biaya Sponsorship</label>
          <input type="text" class="form-control money" id="form-mb_biaya" placeholder="Masukan Breakdown Biaya Sponsorship" name="dt[mb_biaya]">
      </div>

      <div class="form-group">
          <label for="form-mb_periode_awal">Periode awal</label>
          <input type="text" class="form-control tgl" autocomplete="off" id="form-mb_periode_awal" placeholder="Masukan Periode awal" name="dt[mb_periode_awal]">
      </div>

      <div class="form-group">
          <label for="form-mb_periode_akhir">Periode akhir</label>
          <input type="text" class="form-control tgl" autocomplete="off" id="form-mb_periode_akhir" placeholder="Masukan Periode akhir" name="dt[mb_periode_akhir]">
      </div>
