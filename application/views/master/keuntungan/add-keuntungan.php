  <form method="POST" action="<?= base_url('master/Keuntungan/store') ?>" id="upload-create" enctype="multipart/form-data">
    <div class="show_error"></div>
      <div class="form-group">
          <label for="form-keuntungan">Keuntungan</label>
          <input type="text" class="form-control" id="form-keuntungan" placeholder="Masukan Keuntungan" name="dt[keuntungan]">
      </div>
