  <form method="POST" action="<?= base_url('master/Kantor/store') ?>" id="upload-create" enctype="multipart/form-data">
    <div class="show_error"></div>
      <div class="form-group">
          <label for="form-kantor">Kantor</label>
          <input type="text" class="form-control" id="form-kantor" placeholder="Masukan Kantor" name="dt[kantor]">
      </div>
