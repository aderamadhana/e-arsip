  <form method="POST" action="<?= base_url('master/Master_komite/store') ?>" id="upload-create" enctype="multipart/form-data">
    <div class="show_error"></div>
      <div class="form-group">
          <label for="form-mk_nama">Nama Komite</label>
          <input type="text" class="form-control" id="form-mk_nama" placeholder="Masukan Nama Komite" name="dt[mk_nama]">
      </div>
