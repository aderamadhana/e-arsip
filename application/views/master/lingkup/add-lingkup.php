  <form method="POST" action="<?= base_url('master/Lingkup/store') ?>" id="upload-create" enctype="multipart/form-data">
    <div class="show_error"></div>
      <div class="form-group">
          <label for="form-lingkup">Lingkup</label>
          <input type="text" class="form-control" id="form-lingkup" placeholder="Masukan Lingkup" name="dt[lingkup]">
      </div>
