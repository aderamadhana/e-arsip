  <form method="POST" action="<?= base_url('master/Departemen/store') ?>" id="upload-create" enctype="multipart/form-data">
    <div class="show_error"></div>
      <div class="form-group">
          <label for="form-code">Code</label>
          <input type="text" class="form-control" id="form-code" placeholder="Masukan Code" name="dt[code]">
      </div>
